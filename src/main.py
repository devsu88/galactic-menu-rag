...
def main():
    ...
    if args.command == "ingest":
        ...
        print(f"Avvio Ingestion da: {args.data_dir}")
        ...
        if difficulty:
            print(f"Avvio Retrieval per: {args.questions_file} (difficoltà: {difficulty})")
        else:
            print(f"Avvio Retrieval per: {args.questions_file} (tutte le difficoltà)")
